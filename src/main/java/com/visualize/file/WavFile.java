...
//Reference: https://zh.wikipedia.org/wiki/WAV
public class WavFile extends AudioFile{

    private final MediaPlayer mediaPlayer;

    // Constructor
    public WavFile (String path) throws javax.sound.sampled.UnsupportedAudioFileException, java.io.IOException{
        super(path);

        this.audioInputStream = AudioSystem.getAudioInputStream(this);
